...
| Item | Count |
|---|---:|
| Rust spec/fuzz tests | 138 |
| Kani proofs | 136 |
| Kani cover checks | 210 |
...
|---|---:|---:|---:|
| `tests/v14_spec_tests.rs` | 137 | 0 | 0 |
| `tests/v14_fuzzing.rs` | 1 | 0 | 0 |
| `tests/proofs_v14.rs` | 0 | 129 | 202 |
...
The current tree has 136 Kani proofs, so the timing artifacts must be regenerated
...
| `permissionless_recovery_no_caller_chosen_price` | `v14_permissionless_recovery_is_declared_by_reason_not_caller_price`; `v14_permissionless_recovery_cannot_override_resolved_mode`; `v14_recovery_mode_blocks_value_escape_and_fee_sync_before_mutation`; `v14_recovery_mode_rejects_non_recovery_crank_before_account_mutation`; `proof_v14_permissionless_recovery_declares_reason_or_fails_closed`; `proof_v14_recovery_mode_blocks_value_escape_paths_before_mutation`; `proof_v14_recovery_mode_rejects_non_recovery_crank_before_account_mutation`; recovery crank proof |
...
| Check | Result |
|---|---:|
| Harnesses over v14 production transitions | 121 |
| Harnesses over shared production arithmetic helpers | 7 |
| Harnesses with `kani::cover!` reachability checks | 121 |
