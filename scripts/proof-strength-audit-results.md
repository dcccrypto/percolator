...
| `proof_v14_bad_asset_cannot_spend_unrelated_domain_insurance_budget` | 126.98753s | PASS |
...
| `domain_budgeted_insurance_prevents_bad_asset_global_insurance_drain` | `v14_bad_asset_cannot_spend_unrelated_domain_insurance_budget`; `proof_v14_bad_asset_cannot_spend_unrelated_domain_insurance_budget`; domain-budget liquidation proofs |
