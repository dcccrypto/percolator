...
| `proof_permissionless_account_b_progress_reduces_hinted_account_b_rank_on_prod_code` | 233.64s | PASS | Production permissionless account-B progress branch validates, touches, finalizes, and strictly reduces the hinted account's B rank. |
