...
| Item | Count |
|---|---:|
| Rust spec/fuzz tests | 136 |
| Kani proofs | 134 |
| Kani cover checks | 208 |
...
|---|---:|---:|---:|
| `tests/v14_spec_tests.rs` | 135 | 0 | 0 |
| `tests/v14_fuzzing.rs` | 1 | 0 | 0 |
| `tests/proofs_v14.rs` | 0 | 127 | 200 |
...
The current tree has 134 Kani proofs, so the timing artifacts must be regenerated
...
| `permissionless_recovery_no_caller_chosen_price` | `v14_permissionless_recovery_is_declared_by_reason_not_caller_price`; `v14_permissionless_recovery_cannot_override_resolved_mode`; `proof_v14_permissionless_recovery_declares_reason_or_fails_closed`; recovery crank proof |
...
| Check | Result |
|---|---:|
| Harnesses over v14 production transitions | 119 |
| Harnesses over shared production arithmetic helpers | 7 |
| Harnesses with `kani::cover!` reachability checks | 119 |
