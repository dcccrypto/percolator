...
- **Total Proofs**: 90
- **Passed**: 78
- **Failed**: 2 (need multi-account ADL fix)
- **Timeout**: 6 (commented out / deprecated)
- **Slow (>60s)**: 8

### Proofs Needing Attention

**Failed** (same multi-account ADL remainder issue):
- `adl_is_proportional_for_user_and_lp` - 27s, FAIL
- `adl_proportionality_general` - 384s, FAIL
...
**Slow (>60s)**:
- `proof_ps5_panic_settle_no_insurance_minting` - 90s
- `panic_settle_clamps_negative_pnl` - 240s
- `fast_valid_preserved_by_panic_settle_all` - 216s
- `proof_c1_conservation_bounded_slack_force_realize` - 288s
- `adl_proportionality_general` - 384s
- `proof_c1_conservation_bounded_slack_panic_settle` - 414s
- `fast_valid_preserved_by_force_realize_losses` - 452s
- `fast_valid_preserved_by_apply_adl` - 563s
...
| i4_adl_haircuts_unwrapped_first | 21s | PASS |
| withdrawal_requires_sufficient_balance | 2s | PASS |
| pnl_withdrawal_requires_warmup | 2s | PASS |
| multiple_users_adl_preserves_all_principals | 22s | PASS |
...
| i10_risk_mode_triggers_at_floor | 7s | PASS |
| i10_fair_unwinding_constant_haircut_ratio | 1s | TIMEOUT |
| i10_withdrawal_mode_blocks_position_increase | 8s | PASS |
| i10_withdrawal_mode_allows_position_decrease | 4s | PASS |
| i10_total_withdrawals_bounded_by_available | 0s | TIMEOUT |
| i10_top_up_reduces_loss_accum | 1s | TIMEOUT |
| i10_top_up_exits_withdrawal_mode_when_loss_zero | 1s | PASS |
| fast_i10_withdrawal_mode_preserves_conservation | 2s | PASS |
| i10_withdrawal_tracking_accuracy | 0s | TIMEOUT |
| i1_lp_adl_never_reduces_capital | 15s | PASS |
| adl_is_proportional_for_user_and_lp | 27s | FAIL |
| adl_proportionality_general | 384s | FAIL |
| i10_fair_unwinding_is_fair_for_lps | 0s | TIMEOUT |
| multiple_lps_adl_preserves_all_capitals | 22s | PASS |
| mixed_users_and_lps_adl_preserves_all_capitals | 27s | PASS |
| proof_warmup_frozen_when_paused | 7s | PASS |
| proof_withdraw_only_decreases_via_conversion | 2s | PASS |
| proof_risk_increasing_trades_rejected | 8s | PASS |
| panic_settle_closes_all_positions | 2s | PASS |
| panic_settle_clamps_negative_pnl | 240s | PASS |
...
| warmup_budget_d_paused_settlement_time_invariant | 2s | PASS |
...
| proof_r1_adl_never_spends_reserved | 2s | PASS |
| proof_r2_reserved_bounded_and_monotone | 4s | PASS |
| proof_r3_warmup_reservation_safety | 2s | PASS |
| proof_ps5_panic_settle_no_insurance_minting | 90s | PASS |
| proof_c1_conservation_bounded_slack_panic_settle | 414s | PASS |
| proof_c1_conservation_bounded_slack_force_realize | 288s | PASS |
...
| fast_frame_apply_adl_never_changes_any_capital | 22s | PASS |
...
| fast_valid_preserved_by_apply_adl | 563s | PASS |
| fast_valid_preserved_by_settle_warmup_to_capital | 2s | PASS |
| fast_valid_preserved_by_panic_settle_all | 216s | PASS |
| fast_valid_preserved_by_force_realize_losses | 452s | PASS |
...
| neg_pnl_settlement_does_not_depend_on_elapsed_or_slope | 2s | PASS |
